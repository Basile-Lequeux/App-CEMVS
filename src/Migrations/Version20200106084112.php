 ...
 */
final class Version20200106084112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, groupe_id INT NOT NULL, arme_id INT DEFAULT NULL, arbitre_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, genre VARCHAR(255) NOT NULL, blason VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, categorie_age VARCHAR(255) DEFAULT NULL, INDEX IDX_8D93D6497A45358C (groupe_id), INDEX IDX_8D93D64921D9C0A (arme_id), INDEX IDX_8D93D649943A5F0 (arbitre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
