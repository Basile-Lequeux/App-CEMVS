 ...
 */
final class Version20200127140644 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competitions ADD zone_arbitre_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competitions DROP zone_arbitre_id');
    }
}
