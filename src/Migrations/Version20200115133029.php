 ...
 */
final class Version20200115133029 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP date_naissance2');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD date_naissance2 DATE DEFAULT NULL');
    }
}
